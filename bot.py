...
pr0fess0r_99=Client(
    ...
    TELEGRAM_BOT_TOKEN = os.environ["6273125677:AAGvveyqzPDLHHIMhdVyrPyj_kv_X-tYpl4"],
    api_id = int(os.environ["20650942"]),
    api_hash = os.environ["9744c99858433c55c279cce6827d36a4"]
)
